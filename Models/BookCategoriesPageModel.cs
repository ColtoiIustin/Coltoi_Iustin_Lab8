...
namespace Coltoi_Iustin_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Coltoi_Iustin_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Coltoi_Iustin_Lab8Context context,
